...
import { ShoppingCart, UserPlus, LogIn, LogOut, Lock, Mic } from "lucide-react";
						...
						<nav className='flex flex-wrap items-center gap-4'>
						 ...
						 ease-in-out'
							...
							<button
								...
								className='relative text-black hover:text-sky-500 transition duration-300 ease-in-out
							 p-1.5 rounded-full hover:bg-sky-50'
								title='Voice Control'
							>
								<Mic size={20} />
							</button>
